...
namespace UIBK.GraphSPARQL.Types.Providers
{
    ...
    public sealed class RdfHarvester
    {
        ...
        private static readonly IReadOnlyDictionary<Iri, SchemaScalar> KnownScalars = new SchemaScalar[]
        {
            ...
            SchemaScalar.Date("http://www.w3.org/2001/XMLSchema#gYearMonth", "yyyy-MM"),
            SchemaScalar.Date("http://www.w3.org/2001/XMLSchema#gYear",  "yyyy"),
            SchemaScalar.Date("http://www.w3.org/2001/XMLSchema#gMonth",  "--MM-"),
            SchemaScalar.Date("http://www.w3.org/2001/XMLSchema#gMonthDay", "--MM-dd"),
            SchemaScalar.Date("http://www.w3.org/2001/XMLSchema#gDay",  "---dd"),
